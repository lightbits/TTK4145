...
(setq casey-todo-file "~/Documents/ttk4115/project/todo.txt")
(setq casey-log-file "~/Documents/ttk4115/project/log.txt")

(global-hl-line-mode 1)
(set-face-background 'hl-line "#2A2738")

(setq compilation-directory-locked nil)
(scroll-bar-mode -1)
(setq shift-select-mode nil)
(setq enable-local-variables nil)
(setq casey-font "outline-Droid Sans Mono")
...
(when casey-linux
  (setq casey-makescript "~/Documents/ttk4145/misc/build.linux")
...
(defun casey-big-fun-c-hook ()
  ...
  (defun casey-header-format ()
     ...
     (insert "   $Date: $\n")
     (insert "   $Revision: $\n")
     (insert "   $Creator: Simen Haugo $\n")
     (insert "   $Notice: (C) Copyright 2015 by 9BitScience, Inc. All Rights Reserved. $\n")
     (insert "   ======================================================================== */\n")
     (insert "\n")
     (insert "#define ")
     (push-mark)
...
(set-face-attribute 'font-lock-builtin-face nil :foreground "#CC6633")
(set-face-attribute 'font-lock-comment-face nil :foreground "#44A388")
(set-face-attribute 'font-lock-constant-face nil :foreground "#CC6633")
(set-face-attribute 'font-lock-doc-face nil :foreground "#CC6633")
(set-face-attribute 'font-lock-function-name-face nil :foreground "#FDE792")
(set-face-attribute 'font-lock-keyword-face nil :foreground "#CC6633")
(set-face-attribute 'font-lock-string-face nil :foreground "#CC6633")
(set-face-attribute 'font-lock-type-face nil :foreground "#CC6633")
(set-face-attribute 'font-lock-variable-name-face nil :foreground "#FDE792")

(defun post-load-stuff ()
  (interactive)
  (menu-bar-mode -1)
  (maximize-frame)
  (set-foreground-color "#FDE792")
  (set-background-color "#383627")
